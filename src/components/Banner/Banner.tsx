...
function Banner() {
    return (
        <div className="w-full h-[40vh] flex items-center justify-center">
            ...
            <div className="rounded-[28px] w-full h-[234px] bg-white flex items-center justify-between shadow-[23px 19px 138px -45px rgba(12, 169, 65, 0.13)] ">
                ...
                <div className="flex gap-15 pr-[45px]">
                    ...
                    <Counter targetNumber={60} text="Complete Project Per Month." />
                </div>
            </div>
        </div>
    );
