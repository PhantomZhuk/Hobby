    ...
    return (
        <div className="w-[150px] flex flex-col gap-5">
            <svg className="absolute z-0 mt-[-20px]" width="100" height="87" viewBox="0 0 85 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M20.7688 5.68609C39.4052 -5.97915 56.5791 4.71577 69.8427 14.2511C80.8477 22.1626 89.0008 34.3058 80.7549 48.8103C72.6322 63.0979 53.9142 69.4173 37.5897 70.9834C21.3453 72.5418 5.95295 69.0768 2.66213 56.3021C-1.55946 39.9142 1.32487 17.8568 20.7688 5.68609Z" fill="#ECF8F0" />
            </svg>
