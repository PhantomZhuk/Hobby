function SubscribeScreen() {
    return (
        <div className="w-full min-h-[80vh] flex items-center justify-between">
            ...
            <div className="w-full h-[60vh] bg-[#f8f8f8]/[0.5] backdrop-blur-lg p-6 shadow-lg rounded-[19px] py-[120px] px-[280px] flex flex-col items-center justify-center gap-5">
